package com.example.myworkoutlog.service;

import com.example.myworkoutlog.dto.WorkoutInput;
import com.example.myworkoutlog.dto.WorkoutOutput;

import java.time.LocalDateTime;
import java.util.ArrayList;
import java.util.List;

import com.example.myworkoutlog.dto.WorkoutPartOutput;
...
public class WorkoutService {
    ...
    public WorkoutOutput update(Long id, WorkoutInput workoutInput){
        ...
        Workout data = workoutRepository
                .findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, id+" not found"));    // id에 해당하는 workout을 찾을 수 없을 때
